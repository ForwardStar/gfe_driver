...
captions = [
    ...
    "(2) Edge deletion throughput",
    "(3) Memory usage of the graph",
    "(4) Vertex insertion throughput",
    "(5) Vertex query throughput",
    "(6) Memory usage of vertices"
]
...
for idx, (ax, caption) in enumerate(zip(axes, captions), start=1):
    ...
    ax.set_xlabel(caption, fontsize=20, fontweight="bold", labelpad=15)

# Shared legend at top
handles, labels = axes[0].get_legend_handles_labels()
fig.legend(handles, labels,
           loc="upper center",           # center horizontally
           ncol=len(methods), fontsize=20)
