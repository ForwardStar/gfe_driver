...
if [ -n "$1" ]; then
    ...
    if [ -n "$2" ]; then
        ...
        ./build/gfe_driver -G datasets/com-friendster.ungraph.el -u -l $1 -w $2 --is_timestamped true > results/$1/sequential/com-friendster.ungraph-sequential-$1
        if [ "$1" = "forward_star" ]; then
        ...
        ./build/gfe_driver -G datasets/com-friendster.ungraph.el -u -l $1 -w $(nproc) --is_timestamped true > results/$1/sequential/com-friendster.ungraph-sequential-$1
        if [ "$1" = "forward_star" ]; then
            ./optimizer datasets/com-lj.ungraph.el 8 > settings
            echo "0" >> settings
        fi
